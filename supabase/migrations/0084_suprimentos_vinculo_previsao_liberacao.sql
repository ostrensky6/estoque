-- Suprimentos: fecha lacunas operacionais entre compra aberta, previsao
-- liquida e liberacao documentada de lotes criticos.
...
create or replace function aceitar_lote(
  p_lote_id bigint,
