    ...
    <div className="min-h-dvh bg-transparent font-sans text-foreground">
      <main className="app-page-container">
        <div className="mx-auto mt-16 max-w-md rounded-xl border border-border bg-card p-6 shadow-sm">
          <h1 className="text-lg font-semibold">Sem acesso{area ? ` a ${area}` : ""}</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Seu usuário não tem a permissão para abrir esta área. Se precisar dela, peça ao
            administrador para liberar em Usuários.
          </p>
          <Link
            href="/"
