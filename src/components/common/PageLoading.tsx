export function PageLoading({ title = "Carregando" }: { title?: string }) {
  return (
    <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8" aria-busy="true" aria-live="polite">
      ...
      <div className="mt-6 rounded-lg border border-border bg-card p-4 shadow-xs">
