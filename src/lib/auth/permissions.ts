...
export const PERMISSOES: Array<{
  ...
  },
  {
    ...
    descricao: "Revisar, recalcular, emitir, classificar e duplicar propostas. Coordenador ou superior já pode pelo papel.",
  },
  {
    key: "orcamentos.cancelar",
    modulo: "Orçamentos",
    label: "Cancelar",
    descricao: "Cancelar orçamentos, módulos e propostas. Coordenador ou superior já pode pelo papel.",
  },
  {
    key: "orcamento.parametros.editar",
    modulo: "Orçamentos",
    label: "Editar parâmetros",
    descricao: "Manter premissas econômicas e parâmetros globais. Gestor ou superior já pode pelo papel.",
  },
  {
    key: "projetos.ver",
    modulo: "Projetos",
