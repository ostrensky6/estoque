...
feito o diagnostico comparativo entre o app de referencia clonado em
`D:\Aplicativos\Projetos-reference` e o Kontrol na branch
`feat/orcamento-integrado-final`.
...
## Plano tecnico curto de implementacao executado
...
Diagnostico entregue neste documento e implementacao autorizada pela instrucao
operacional de 2026-06-22. A migration aditiva `0044` e os scripts
`scripts/backup-orcamento-integrado.ps1`,
`scripts/validate-orcamento-integrado.sql` e
`scripts/rollback-orcamento-integrado-0044.sql` foram preparados sem operacoes
destrutivas. A unica acao externa pendente para producao e executar backup
logico, aplicar migrations e rodar a validacao no Supabase alvo.
